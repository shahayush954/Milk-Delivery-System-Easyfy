...
<body>
	<a href="customer-prepaid.php?vid=<?php echo $row1['v_id']; ?>"><img src="back.png" width="60" height="60" style="left: 15px;top:25px;position: fixed;"></a>
	...
	<a href="php/make-payment.php?amount=<?php echo $row2['v_milk_charge']*$_SESSION['multiple_litres']; ?>"><button type="button" class="button"style="position: center;">Pay</button></a>
</div>
</body>
</html>