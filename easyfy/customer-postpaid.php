...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="customer-postpaid.css">
	<style type="text/css">
	.display-img {
...
<body style="margin-top: 100px;">
	...
	<div class="profile-pic">
		<?php 
			echo "<img src='data:image/jpeg;base64,".base64_encode($row3['v_image'])."' height='350' width='350'>";
		 ?>

		 <h1 style="font-weight: normal; margin-bottom: 25px; margin-top: 18px;">Milk Brand :  <?php echo $row3['v_milk_brand']; ?></h1>
		<h1 style="font-weight: normal; margin-bottom: 29px; margin-top: -20px;">Rs. <?php echo $row3['v_milk_charge']; ?>/liter</h1>
	</div>
	<form action="php/change-customer-milk-details-postpaid.php" method="POST">
	<div class="paid">
			<!--<a href="#" onclick="prepaid()" >Postpaid</a>-->
			<input type="radio" name="payment"> <p style=" margin: 3% 0;border: 2px solid #ff7878;color: #fff;border-radius: 50px;background: #ff7878;padding: 1.5% 3%;width: 20%;text-align: center;font-size: 50px;font-size: 50px;">Postpaid</p>
