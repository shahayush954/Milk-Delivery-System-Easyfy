...
var test;
	...
	$(function(){
		...
		var x_date = '<?php echo $row3['c_register_date']; ?>';
		...
		function changeRequest(){
			var lit = document.getElementById('number').value;
			$.ajax({
				url:"php/milkchangerequest.php?change=request",
				method:"POST",
				data:{datedata:test,litres:lit},
				dataType:"json",
				processData:false,
...
<div class="detailss" id="edit1">
	...
	<img src="edit.png" height="50" width="50" style="display: inline; margin-left: 65%; " id = "edit-btn">
	</div>
	<div class="inline">
...
<div class="detailss1" id="edit">
	...
	<input type="button" name="submit" onclick="changeRequest()" value="send request" style="font-size: 40px;width: 200px;background-color: #ff7878;color: #fff;border-radius: 25px;">
</div>
...
?>
<form method="POST" id="search2" action="<?php echo $update; ?>">
<div class="detailss" id="edit1">
	<div style="">
...
<div class="detailss1" id="edit2">
	...
	<input type="number" id="num" value='1' style="padding-left: 0px; margin-top: 0; display: inline; font-size: 50px; position: relative; left: 40px; top:30px;width: 10%;">
