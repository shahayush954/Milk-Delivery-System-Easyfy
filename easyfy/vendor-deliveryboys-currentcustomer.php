...
<body>
	<a href="vendor-currentday-del-boys.php"><img src="back.png" width="60" height="60" style=" z-index: 999; position:fixed;left: 10px; top: 20px;"></a>
	...
	switch($row2['residence_type']){
		case 'Building':
			...
			echo "
				...
				<p>".$row3['c_flat_no'].", ".$row3['c_building_name'].", ".$row3['c_area'].",Litres:".$litres." </p>
				</div>
			";
		...
		case 'Bungalow':
			...
			echo "
				<div class='building-name'>
				<p>".$row3['c_bungalow_no'].", ".$row3['c_bungalow_name'].", ".$row3['c_area'].",Litres:".$litres." </p>
				</div>
			";
		...
		case 'Chawl':
			...
			echo "
				<div class='building-name'>
				<p>".$row3['c_room_no'].", ".$row3['c_chawl_name'].", ".$row3['c_area'].",Litres:".$litres." </p>
				</div>
			";
		...
		case 'Shop':
			...
			echo "
				<div class='building-name'>
				<p>".$row3['c_shop_no'].", ".$row3['c_shop_name'].", ".$row3['c_area'].",Litres:".$litres." </p>
				</div>
			";
